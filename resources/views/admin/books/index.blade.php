            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="mb-6">
                    <div class="relative max-w-sm">
                        ...
                        <input type="text" id="searchInput" placeholder="Search books by title..." class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition duration-150 ease-in-out" value="{{ request('search') }}">
                    </div>
                </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($books as $book)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $book->author?->pseudonym ?? ($book->author?->name ?? 'Unknown Author') }}</td>
            ...
            searchInput.addEventListener('input', function() {
                ...
                timeout = setTimeout(function() {
                    ...
                    .then(html => {
                        ...
                        const newTableBody = doc.querySelector('#booksTable tbody');
