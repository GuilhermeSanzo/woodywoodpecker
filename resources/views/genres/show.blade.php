...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6">
                <a href="{{ route('genres.index') }}" class="inline-flex items-center text-sm font-medium text-indigo-600 hover:text-indigo-900 transition duration-150 ease-in-out">
            ...
            <div class="mb-8">
                <h3 class="text-2xl font-bold text-gray-900 mb-6 border-l-4 border-indigo-600 pl-4">{{ __('Books in') }} {{ $genre->name }}</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    ...
                    @empty
                        <div class="col-span-full bg-white overflow-hidden shadow-sm sm:rounded-lg p-12 text-center text-gray-500 italic border border-gray-100">
                            {{ __('No books listed in this genre yet.') }}
                        </div>
                    @endforelse
                </div>
            </div>
