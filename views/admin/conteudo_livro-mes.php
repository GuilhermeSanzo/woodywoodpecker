...
<?php
	...
	if (isset($_REQUEST['btn_enviar'])) {
		...
		//echo($sql);
		mysql_query($sql);
		header("location: /views/admin/conteudo_livro-mes.php");
					...
					<tbody>
						...
						<tr>
							...
							<td class="linha_opcoes">
								<a class="opcoes_link" href="/views/admin/conteudo_livro-mes.php?modo=excluir&codigo=<?php echo($rs['cod_livro_mes']) ?>">Excluir</a>					
							</td>
							<td class="linha_opcoes">
								<a class="opcoes_link" href="/views/admin/conteudo_livro-mes.php?modo=editar&codigo=<?php echo($rs['cod_livro_mes']) ?>">Editar</a>
							</td>
						</tr>
						<?php
							}
