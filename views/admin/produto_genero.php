...
<?php
	...
	if (isset($_REQUEST['btn_enviar'])) {
		...
		if ($_REQUEST['btn_enviar'] == "Editar") {
			$sql = "update genero set nome = '".$nome."' where cod_genero = ".$_SESSION["codigo"]."";
		}

		//echo($sql);
		mysql_query($sql);
		header("location: /views/admin/produto_genero.php");
	...
	if (isset($_REQUEST['modo'])) {
		...
		if ($modo == "editar") {
			...
			$sql = "select * from genero where cod_genero=".$_SESSION['codigo']."";
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/public/css/admin/estilo_cms-usuarios.css">
	<link type="text/css" rel="stylesheet" href="/public/css/admin/estilo_cms-produto.css">

	<!-- Efeito / Estilo do Accordion -->
...
<body>
	...
	<section id="corpo">
		...
		<section id="conteudo">
			<h2 id="titulo_gerenciamento">Gênero</h2>
				...
				<div id="accordion">
					...
					<div>
						<div id="inserir">
							<form name="produto_genero_form" method="post">
								<table id="tbl_cms_usuarios">
									<thead>
										<tr>
											<th colspan="2">Cadastro de Gêneros</th>
										</tr>
									</thead>
									<tbody>
										<tr>
						...
						<div id="consulta">
							<table id="tblconsulta">
								...
								<tbody>
									...
									<?php
										$sql = "select * from genero order by cod_genero desc limit 10";
									...
									<tr>
										...
										<td class="linha_opcoes">
											<a class="opcoes_link" href="/views/admin/produto_genero.php?modo=excluir&codigo=<?php echo($rs['cod_genero']) ?>">Excluir</a>					
										</td>
										<td class="linha_opcoes">
											<a class="opcoes_link" href="/views/admin/produto_genero.php?modo=editar&codigo=<?php echo($rs['cod_genero']) ?>">Editar</a>
										</td>
									</tr>
									<?php
										}
