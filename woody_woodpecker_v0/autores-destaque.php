...
<head>
	...
	<link type="text/css" rel="stylesheet" href="Estilo/estilo_autores-destaque.css">
...
<body>
		...
		<div id="centraliza_cabecalho">
			...
			<nav id="menu">
				<ul>
					...
					<li><a href="autores-destaque.php" class="menu_page">Autores em destaque</a></li>
	...
	<section id="corpo">
		...
		<section id="principal">
			...
			<!-- Primeira lista -->
			<div class="produtos">
				<img src="Imagens/Autores/Tolkien.jpg" alt="Autor">
				<ul>
