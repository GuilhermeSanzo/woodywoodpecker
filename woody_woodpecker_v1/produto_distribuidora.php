...
<?php
	...
	if (isset($_REQUEST['btn_enviar'])) {
		...
		//echo($sql);
		mysql_query($sql);
		header("location:produto_distribuidora.php");
					...
					<tbody>
						...
						<tr>
							...
							<td class="linha_opcoes">
								<a class="opcoes_link" href="produto_distribuidora.php?modo=excluir&codigo=<?php echo($rs['cod_distribuidora']) ?>">Excluir</a>					
							</td>
							<td class="linha_opcoes">
								<a class="opcoes_link" href="produto_distribuidora.php?modo=editar&codigo=<?php echo($rs['cod_distribuidora']) ?>">Editar</a>
							</td>
						</tr>
						<?php
							}
