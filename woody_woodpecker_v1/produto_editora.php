...
<?php
	...
	if (isset($_REQUEST['btn_enviar'])) {
		...
		//echo($sql);
		mysql_query($sql);
		header("location:produto_editora.php");
					...
					<tbody>
						...
						<tr>
							...
							<td class="linha_opcoes">
								<a class="opcoes_link" href="produto_editora.php?modo=excluir&codigo=<?php echo($rs['cod_editora']) ?>">Excluir</a>					
							</td>
							<td class="linha_opcoes">
								<a class="opcoes_link" href="produto_editora.php?modo=editar&codigo=<?php echo($rs['cod_editora']) ?>">Editar</a>
							</td>
						</tr>
						<?php
							}
